...
export const SEVERITIES = ['ok', 'info', 'warn', 'critical'] as const;
...
function formatTableAsMarkdown({ headers, rows }: any) {
...
function notionRichText(text, opts: any = {}) {
...
function notionParagraph(text, color?: any) {
  const block: any = {
    object: 'block',
    type: 'paragraph',
