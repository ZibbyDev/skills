 ...
 */
export async function fetchOpenAICosts({ startMs, endMs, groupBy = ['project_id', 'line_item'] }: any) {
 ...
 */
export async function fetchAnthropicCosts({ startMs, endMs, groupBy = ['workspace_id'] }: any) {
 ...
 */
export async function fetchCursorSpend({ startMs, endMs }: any) {
 ...
 * }>}
 */
export async function fetchAllProviders({ startMs, endMs }: any) {
