...
const DOLT_BIN = 'dolt';
const EXEC_OPTS: any = { encoding: 'utf-8', stdio: ['pipe', 'pipe', 'pipe'], timeout: 15_000 };
...
const MEMORY_ADAPTERS: any = { dolt: doltAdapter, mem0: mem0Adapter };
...
export const chatMemorySkill: any = {
  id: 'chat-memory',
...
fact, decision, context, insight, credential, url, error, workaround`,
  ...
  async buildPromptContext(context, args: any = {}) {
