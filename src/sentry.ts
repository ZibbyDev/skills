...
export async function sentryFetch(path, opts: any = {}) {
 ...
 */
export async function sentryListIssues({ query = 'is:unresolved', sort = 'date', project, limit = 25 }: any = {}) {
 ...
 */
export async function sentryUpdateIssue(issueId, update: any = {}) {
